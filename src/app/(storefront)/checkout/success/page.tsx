...
export default function OrderSuccessPage() {
  ...
  useEffect(() => {
    ...
    localStorage.removeItem('instalook_guest_id');
    localStorage.removeItem('instalook_guest_info');
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-white items-center justify-center p-6 text-center">
      ...
      {/* instalook Branded Footer */}
      <div className="mt-auto pb-8">
        <p className="text-[10px] font-black tracking-[0.5em] text-gray-200 uppercase">instalook Originals</p>
      </div>
    </div>
  );
}
