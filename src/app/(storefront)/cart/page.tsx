  ...
  const handleApplyCoupon = async () => {
    try {
      ...
      if (res.ok) {
        ...
        localStorage.setItem('savana_coupon', JSON.stringify({ code: coupon, discount: disc }));
      } else {
        alert(data.message);
      }
    } catch (e) {
           ...
           >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                   ...
                   <p className="text-[11px] text-gray-400 font-medium">Extra 10% OFF with SAVANA10</p>
                </div>
              </div>
