...
export default function AuthPage() {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('savana_token', data.token);
      localStorage.setItem('savana_user', JSON.stringify(data.user));
    ...
    <div className="flex flex-col min-h-screen bg-white">
       <div className="flex-1 flex flex-col px-6 pt-10">
         ...
         <div className="mt-auto pb-10 text-center flex flex-col items-center">
            <p className="text-[10px] uppercase font-bold tracking-widest text-[#FF4D6D]/50 mb-2">SECURED BY SAVANA</p>
